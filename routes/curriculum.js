...
// Real, complete subject list for the user's exam, with real
// aggregated mastery % per subject (0 for a brand-new user).
// ════════════════════════════════════════════════════════════════
...
// on each chapter (status defaults to not_started if never touched).
// ════════════════════════════════════════════════════════════════
...
// capped at 3 (matches the dashboard's Continue Learning slots).
// Empty array for a user who hasn't started anything yet — honest,
// not faked.
// ════════════════════════════════════════════════════════════════
...
// Record real activity on a chapter. Body: { unitsCompleted } or
// { percentComplete } or { status }. Upserts — first call on a
// chapter creates its progress row.
// ════════════════════════════════════════════════════════════════
